...
// arModel is a active record design model for table messages operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of messages.
	Table = "messages"
	// Model is the model object of messages.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table messages.
	Columns = struct {
		Id        string //   
        Suid      string //   
        Ruid      string //   
