...
// arModel is a active record design model for table likes operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of likes.
	Table = "likes"
	// Model is the model object of likes.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table likes.
	Columns = struct {
		Id        string //                     
        Uid       string // 点赞用户ID          
        Tid       string // 点赞目标ID          
        Type      string // 点赞目标类型        
        Status    string // 点赞状态:1-是/0-否  
        CreateAt  string // 点赞时间            
        UpdateAt  string // 点赞时间
	}{
		Id:       "id",         
        Uid:      "uid",        
        Tid:      "tid",        
