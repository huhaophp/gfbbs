...
// arModel is a active record design model for table sensitives operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sensitives.
	Table = "sensitives"
	// Model is the model object of sensitives.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table sensitives.
	Columns = struct {
		Id          string //                         
        Word        string // 敏感词                  
        Type        string // 类型                    
        Substitute  string // 替换类型需要替换的文本  
        CreatedAt   string //                         
        UpdatedAt   string //
	}{
		Id:         "id",          
