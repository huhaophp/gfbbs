...
// arModel is a active record design model for table like operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of like.
	Table = "like"
	// Model is the model object of like.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table like.
	Columns = struct {
		Id        string //                     
        Uid       string // 点赞用户ID          
        Tid       string // 点赞目标ID          
